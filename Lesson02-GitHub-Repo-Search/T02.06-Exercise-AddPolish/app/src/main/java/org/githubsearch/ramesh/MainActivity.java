 ...
 */
package org.githubsearch.ramesh;
...
import org.githubsearch.ramesh.datafrominternet.R;

import org.githubsearch.ramesh.utilities.NetworkUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewErrorMessage = (TextView) findViewById(R.id.tv_error_message_dispaly);
    ...
    public void showJsonDataView(){
        viewErrorMessage.setVisibility(View.INVISIBLE);

    }

    // Done (15) Create a method called showErrorMessage to show the error and hide the data
    public void showErrorMessage (){
        viewErrorMessage.setVisibility(View.VISIBLE);
    }
